...
import SearchableEditableTable from './SearchableEditableTable';
      ...
      <Layout style={{ marginLeft: 200 }}>
        <Header style={{
          ...
          <Steps current={this.state.atStep}>
            <Step  status="finish" title="Click" description="Click on vocabulary to edit."  icon={<Icon type="select" />} />
